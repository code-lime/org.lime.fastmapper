...
public class IterableTypeConverter implements TypeConverter<Iterable, Iterable> {
    @Override
    public Iterable convert(FastMapper mapper, Iterable value) {
        throw new IllegalArgumentException("Type support only generic");
    }

    @Override
    public Iterable convert(FastMapper mapper, Iterable value, Type inType, Type outType) {
